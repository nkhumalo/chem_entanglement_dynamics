...
def CombineMols(mol1: Mol, mol2: Mol, offset: Point3D = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CombineMols(RDKit::ROMol,RDKit::ROMol [,RDGeom::Point3D=<rdkit.Geometry.rdGeometry.Point3D object at 0x1047bf5c0>])
    """
...
def CopyMolSubset(mol: Mol, atomIndices: typing.Any, bondIndices: typing.Any, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,boost::python::api::object [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x10479fbc0>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, atomIndices: typing.Any, bondIndices: typing.Any, subsetInfo: SubsetInfo, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,boost::python::api::object,RDKit::SubsetInfo {lvalue} [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x10479fc30>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, path: typing.Any, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x10479fca0>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, path: typing.Any, subsetInfo: SubsetInfo, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,RDKit::SubsetInfo {lvalue} [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x10479fd80>])
    """
...
def molzip(a: Mol, b: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(RDKit::ROMol,RDKit::ROMol [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x1047da840>])
    """
@typing.overload
def molzip(a: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(RDKit::ROMol [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x1047da8e0>])
    """
@typing.overload
def molzip(row: dict, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(boost::python::dict [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x1047daa20>])
    """
def molzipFragments(mols: typing.Any, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzipFragments(boost::python::api::object {lvalue} [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x1047da980>])
    """
